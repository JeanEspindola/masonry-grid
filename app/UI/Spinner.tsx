export function Spinner() {
	return (
		<div className="h-full flex" data-testid="spinner">
			<div
				className="grid min-h-[300px] w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible">
